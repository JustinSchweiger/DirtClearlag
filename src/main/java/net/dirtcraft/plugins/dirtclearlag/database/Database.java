...
public class Database {
	...
	private static void createDataSource() {
		try {
			...
			ds.setJdbcUrl("jdbc:h2:" + DirtClearlag.getPlugin().getDataFolder().getAbsolutePath() + "/data/dirtloader");
	...
	public static void initialiseDatabase() {
		InputStream inputStream = DirtClearlag.getPlugin().getResource("dbsetup.sql");
